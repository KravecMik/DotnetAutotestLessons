...
//Благодаря пространству имен, компилятор понимает откуда ты берешь тот или иной кусок кода.
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            ////Проще говоря ООП - это способ программирования, где всё представляется в виде объектов как в реальном мире. И все типы переменных тоже наследуются от object. В дебри пока погружаться не будем, поэтому просто
